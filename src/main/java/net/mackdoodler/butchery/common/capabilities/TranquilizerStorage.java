...
public class TranquilizerStorage implements IStorage<ITranquilizer> 
{ 
	@Override 
	public NBTBase writeNBT(Capability<ITranquilizer> capability, ITranquilizer instance, EnumFacing side){
	...
	@Override 
	public void readNBT(Capability<ITranquilizer> capability, ITranquilizer instance, EnumFacing side, NBTBase nbt){
