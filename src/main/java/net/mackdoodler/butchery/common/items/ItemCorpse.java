...
import net.mackdoodler.butchery.api.ButcheryEntries.ButcherEntry;
...
public class ItemCorpse extends Item{
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        if (player.canPlayerEdit(pos, facing, itemstack))
        {
        	...
        	worldIn.setBlockState(pos, ButcheryBlocks.blockCorpse.getStateFromMeta(randy.nextInt(8)), 10);
        	...
        	if (worldIn.getTileEntity(pos) instanceof TileEntityCorpse)
            {
        		...
        		if(ButcheryEntries.butcherEntries.containsKey(itemstack.getTagCompound().getString("corpseType"))){
        			tileEntity.fillInventory(((ButcherEntry)(ButcheryEntries.butcherEntries.get(itemstack.getTagCompound().getString("corpseType")))).getEntries());
                }
