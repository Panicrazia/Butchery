...
import net.mackdoodler.butchery.common.blocks.BlockButcherMat;
...
public class ItemButcherMat extends Item{
        ...
        else
        {
            ...
            if (player.canPlayerEdit(pos, facing, itemstack))
            {
        		...
        		if(worldIn.getBlockState(pos.north(2)).getMaterial().isSolid()&&
        			...
        			worldIn.setBlockState(pos, ButcheryBlocks.butcherMat.getDefaultState()
                	...
                	worldIn.setBlockState(pos.west(), ButcheryBlocks.butcherMat.getDefaultState()
                			.withProperty(BlockButcherMat.STICK, false)
                			.withProperty(BlockButcherMat.EDGE, false)
                			.withProperty(BlockButcherMat.ORIENTATION, true)
                			.withProperty(BlockButcherMat.CENTER, false), 10);
                	worldIn.setBlockState(pos.east(), ButcheryBlocks.butcherMat.getDefaultState()
                			.withProperty(BlockButcherMat.STICK, false)
                			.withProperty(BlockButcherMat.EDGE, false)
                			.withProperty(BlockButcherMat.ORIENTATION, true)
                			.withProperty(BlockButcherMat.CENTER, false), 10);
                	worldIn.setBlockState(pos.south(), ButcheryBlocks.butcherMat.getDefaultState()
                			.withProperty(BlockButcherMat.STICK, false)
                			.withProperty(BlockButcherMat.EDGE, true)
                			.withProperty(BlockButcherMat.ORIENTATION, true)
                			.withProperty(BlockButcherMat.CENTER, true), 10);
                	worldIn.setBlockState(pos.south().west(), ButcheryBlocks.butcherMat.getDefaultState()
                			.withProperty(BlockButcherMat.STICK, false)
                			.withProperty(BlockButcherMat.EDGE, true)
                			.withProperty(BlockButcherMat.ORIENTATION, true)
                			.withProperty(BlockButcherMat.CENTER, false), 10);
                	worldIn.setBlockState(pos.south().east(), ButcheryBlocks.butcherMat.getDefaultState()
                			.withProperty(BlockButcherMat.STICK, false)
                			.withProperty(BlockButcherMat.EDGE, true)
                			.withProperty(BlockButcherMat.ORIENTATION, true)
                			.withProperty(BlockButcherMat.CENTER, false), 10);
                	worldIn.setBlockState(pos.north(), ButcheryBlocks.butcherMat.getDefaultState()
                			.withProperty(BlockButcherMat.STICK, true)
                			.withProperty(BlockButcherMat.EDGE, false)
                			.withProperty(BlockButcherMat.ORIENTATION, true)
                			.withProperty(BlockButcherMat.CENTER, true), 10);
                	worldIn.setBlockState(pos.north().west(), ButcheryBlocks.butcherMat.getDefaultState()
                			.withProperty(BlockButcherMat.STICK, true)
                			.withProperty(BlockButcherMat.EDGE, false)
                			.withProperty(BlockButcherMat.ORIENTATION, true)
                			.withProperty(BlockButcherMat.CENTER, false), 10);
                	worldIn.setBlockState(pos.north().east(), ButcheryBlocks.butcherMat.getDefaultState()
                			.withProperty(BlockButcherMat.STICK, true)
                			.withProperty(BlockButcherMat.EDGE, false)
                			.withProperty(BlockButcherMat.ORIENTATION, true)
                			.withProperty(BlockButcherMat.CENTER, false), 10);
