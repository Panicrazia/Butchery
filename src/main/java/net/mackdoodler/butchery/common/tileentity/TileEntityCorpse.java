package net.mackdoodler.butchery.common.tileentity;
...
import net.mackdoodler.butchery.api.ButcheryEntries.IndividualButcherEntry;
import net.mackdoodler.butchery.common.handlers.ButcheryItemStackHandler;
...
public class TileEntityCorpse extends TileEntity{
	...
	/**
	 * called once upon placement to form the inventory of the corpse
	 * @param list
	 * @return
	 */
	...
	/**
	 * returns a random itemstack from the tile entity eligible for the tool the player is using
	 * @param player
	 * @return
	 */
