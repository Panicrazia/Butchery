...
/**
 * This shit is because for whatever reason the default IItemHandler doesn't work as it should for what I need... for whatever reason 
 * 	this shooouuld be how the original works, except this one actually works
 * @author Mackenzie
 *
 */
